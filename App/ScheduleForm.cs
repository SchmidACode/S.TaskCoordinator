...
namespace ScheduleTaskCoordinator
{
    public partial class ScheduleForm : Form
    {
        ...
        public ScheduleForm()
        {
            ...
            dateStartTime.Value = DateTime.Today;
        ...
        private void AddScheduleItem()
        {
            ...
            connector.InsertDataToBase("Schedule", "Plan, DayOfWeek, StartTime, EndTime", $"'{plan}', {(int)day}, '{start.ToString(@"hh\:mm")}', '{end.ToString(@"hh\:mm")}'");
            LoadTable();
        }
